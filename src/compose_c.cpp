...
{
    composeloop<TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE>(*this);
}
...
{
    composeloop<FALSE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE>(*this);
}

void Composer::compose_regen_MMXfrag_cps()
{
    composeloop<FALSE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE>(*this);
}

void Composer::compose_regen_cps_multipart()
{
    composeloop<FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, FALSE>(*this);
}

void Composer::compose_regen_cps_multipart_callcount()
{
    composeloop<FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, FALSE>(*this);
}

void Composer::compose_regen_cps()
{
    composeloop<FALSE, FALSE, TRUE, FALSE, FALSE, FALSE, FALSE>(*this);
}

void Composer::compose_regen_cps_callcount()
{
    composeloop<FALSE, FALSE, TRUE, FALSE, TRUE, FALSE, FALSE>(*this);
}

void Composer::compose_MMXfrag_cps()
{
    composeloop<FALSE, TRUE, FALSE, TRUE, FALSE, FALSE, FALSE>(*this);
}

void Composer::compose_palindromic_cps()
{
    composeloop<TRUE, FALSE, TRUE, FALSE, FALSE, FALSE, FALSE>(*this);
}
...
{
    composeloop<FALSE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE>(*this);
}

void Composer::compose_regen_MMXfrag_falsebits()
{
    composeloop<FALSE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE>(*this);
}

void Composer::compose_regen_falsebits_multipart()
{
    composeloop<FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, TRUE>(*this);
}

void Composer::compose_regen_falsebits_multipart_callcount()
{
    composeloop<FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE>(*this);
}

void Composer::compose_regen_falsebits()
{
    composeloop<FALSE, FALSE, TRUE, FALSE, FALSE, FALSE, TRUE>(*this);
}

void Composer::compose_regen_falsebits_callcount()
{
    composeloop<FALSE, FALSE, TRUE, FALSE, TRUE, FALSE, TRUE>(*this);
}

void Composer::compose_MMXfrag_falsebits()
{
    composeloop<FALSE, TRUE, FALSE, TRUE, FALSE, FALSE, TRUE>(*this);
}

void Composer::compose_palindromic_falsebits()
{
    composeloop<TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE>(*this);
}

void Composer::compose_falsebits()
{
    composeloop<FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE>(*this);
}

void Composer::compose_falsebits_callcount()
{
    composeloop<FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE>(*this);
}
...
{
    composeloop<FALSE, TRUE, FALSE, FALSE, TRUE, FALSE, FALSE>(*this);
}

void Composer::compose_palindromic()
{
    composeloop<TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE>(*this);
}

void Composer::compose_()
{
    composeloop<FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE>(*this);
}

void Composer::compose_callcount()
{
    composeloop<FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, FALSE>(*this);
}
